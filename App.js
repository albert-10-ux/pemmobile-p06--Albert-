    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        <TextInput
          ...
          placeholder="🔎 Cari produk (misal: Gadget)..."
          value={searchText}
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, backgroundColor: '#1e1e1e', borderBottomWidth: 1, borderBottomColor: '#2a2a2a', elevation: 5,},
  title: { fontSize: 24, fontWeight: '700', color: '#FF6B6B' },
  count: { fontSize: 16, color: '#fff' },
  ...
  chip: { paddingHorizontal: 20, paddingVertical: 8, backgroundColor: '#1e1e1e', borderRadius: 999, marginRight: 8, borderWidth: 1, borderColor: '#2a2a2a' },
  chipActive: { backgroundColor: '#000000', borderColor: '#fff' },
  chipText: { color: '#555', fontWeight: '500' },
  chipTextActive: { color: '#fff' },

  toolbar: { flexDirection: 'row', paddingHorizontal: 16, alignItems: 'center', marginBottom: 8 },
  sortScroll: { flex: 1 },
  sortChip: { paddingHorizontal: 16, paddingVertical: 6, backgroundColor: '#000000', borderRadius: 20, marginRight: 8 },
  sortChipActive: { backgroundColor: '#000000' },
  sortChipText: { fontSize: 13, color: '#555' },
  sortChipTextActive: { color: '#fff' },

  toggleGroup: { flexDirection: 'row', backgroundColor: '#1e1e1e', borderRadius: 999, padding: 4, shadowColor: '#000', shadowOpacity: 0.1, elevation: 4 },
  toggleBtn: { paddingHorizontal: 14, paddingVertical: 6 },
  toggleActive: { backgroundColor: '#000000', borderRadius: 999 },
  toggleText: { fontSize: 18 },

  listContent: { paddingBottom: 30 },
  columnWrapper: { justifyContent: 'space-between' },

  sectionHeader: { backgroundColor: '#1e1e1e', padding: 16, borderBottomWidth: 1, borderBottomColor: '#2a2a2a' },
  ...
  searchInput: {
    ...
    height: 48,
    fontSize: 16,
    color: '#fff', // ⬅️ ini yang bikin teks jadi putih
  },
});
